...
public class TodayChartRendererProvider 
extends AbstractRendererProvider 
{
	private int mFillColorAlpha = 60;
	
	public TodayChartRendererProvider(Context _ctx) 
	{
		super(_ctx);
	}
	public TodayChartRendererProvider(Context _ctx, boolean _createFixedLabels) 
	{
