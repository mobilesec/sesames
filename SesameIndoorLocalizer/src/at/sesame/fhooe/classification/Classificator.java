...
import at.sesame.fhooe.classification.ClassificatorException.ExceptionType;
...
//		}
		...
		Instances inst = InstanceHelper.getInstancesFromAssets(mContext.getAssets(), _path);
...
//	}
	...
	public String classify(ArrayList<ScanResult> _results) throws ClassificatorException
	{
		...
		if(null==i)
		{
			throw new ClassificatorException(mContext, ExceptionType.NO_BSSID_RECOGNIZED);
		}
		mLastInstance = i;
