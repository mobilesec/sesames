...
//		Color c = new Color();
//		ColorDrawable cd = new ColorDrawable(android.R.color.)
//		int bg = android.R.attr.background;
		
		renderer.setMarginsColor(Color.rgb(243, 243, 243)); 
...
//		renderer.setMarginsColor(Color.GREEN);
		...
		for (int i = 0; i < length; i++) {
			...
			if(i==3)
			{
				...
				int col = colors[i];
				r.setFillBelowLineColor(Color.argb(50, Color.red(col), Color.green(col), Color.blue(col)));
				r.setLineWidth(5.5f);
