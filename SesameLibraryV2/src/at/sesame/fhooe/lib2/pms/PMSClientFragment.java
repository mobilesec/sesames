...
//	private PMSActionInProgressDialogFragment mActionInProgressDialog;
	...
	public PMSClientFragment(Context _ctx, FragmentManager _fragMan, Handler _handler)
	{
		mCtx = _ctx;
		mFragMan = _fragMan;
...
//		queryControllableDevicesTest(50);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mUiHelper = new PmsUiHelper(mCtx, this, activeDeviceControlContainer, inactiveDeviceControlContainer);
		mAdapter = new ControllableDeviceAdapter(mCtx, this, mEntries, mUiHelper);
...
//		new PMSCantShutdownDialogFragment().show(mFragMan, null);+
		PMSDialogFactory.showDialog(DialogType.CANT_SHUTDONW_DIALOG, getFragmentManager(), mPmsController, new Object[]{_mac});
	}
...
//		new PMSCantWakeUpDialogFragment().show(mFragMan, null);
		PMSDialogFactory.showDialog(DialogType.CANT_WAKEUP_DIALOG, getFragmentManager(), mPmsController, new Object[]{_mac});
	}
