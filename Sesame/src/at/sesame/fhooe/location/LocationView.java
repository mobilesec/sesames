...
extends Activity
implements ILocationUpdateReceiver
{
	/**
	...
	public void onCreate(Bundle _savedInstance)
	{
		...
		new LocationAccess(this).registerLocationUpdateReceiver(this);
		showDialog(LOCATION_UPDATE_DIALOG);
	}
	...
	public void updateLocation(Location l)
	{
		...
		{
			dismissDialog(LOCATION_UPDATE_DIALOG);
	...
	private void updateGeoCoderInfo()
	{
		...
		{
			dismissDialog(GEO_CODER_DIALOG);
		}
	}
}
