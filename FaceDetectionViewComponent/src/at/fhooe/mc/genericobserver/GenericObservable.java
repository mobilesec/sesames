package at.fhooe.mc.genericobserver;
...
/**
 * Generic version of {@link Observable}.
 * 
 * @author Rainhard Findling
 * @date 02.03.2012
 * @version 1
 * @param <T>
 *            type of object transported via
 *            {@link GenericObserver#update(java.util.Observable, Object)}.
 */
public class GenericObservable<T> {
	...
	public GenericObservable() {
		obs = new Vector<GenericObserver<T>>();
	}
